...
public final class BleProfile {
	...
	public BleProfile(String serviceUuid, String txUuid, String rxUuid) {
		this(UUID.fromString(serviceUuid), UUID.fromString(txUuid), UUID.fromString(rxUuid));
	}

	public BleProfile(UUID serviceUuid, UUID txUuid, UUID rxUuid) {
